            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-200">manu@example.com</p>
                </div>
              </div>
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full bg-slate-900 border border-cyan-700/30 rounded-lg px-4 py-3 text-gray-200 placeholder-gray-400 focus:border-cyan-700 focus:outline-none transition-colors"
              ...
              <div>
                ...
                <textarea
                  rows={5}
                  className="w-full bg-slate-900 border border-cyan-700/30 rounded-lg px-4 py-3 text-gray-200 placeholder-gray-400 focus:border-cyan-700 focus:outline-none transition-colors resize-none"
              ...
              <button
                type="submit"
                className="w-full bg-linear-to-r from-cyan-600 to-teal-500 text-gray-200 font-semibold py-3 px-6 rounded-lg hover:from-cyan-800 hover:to-cyan-950 transition-all duration-300 transform hover:scale-105 shadow-lg shadow-cyan-800/25"
              >
                Send Message
              </button>
            </form>
