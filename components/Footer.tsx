        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.linkedin.com/in/manu-s-b98151308/" target="_blank" rel="noopener noreferrer"
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              <span className="text-xs bg-purple-500/10 border border-purple-500/30 text-purple-300 px-2 py-1 rounded">React</span>
              <span className="text-xs bg-blue-500/10 border border-blue-500/30 text-blue-300 px-2 py-1 rounded">Next.js</span>
              <span className="text-xs bg-cyan-500/10 border border-cyan-500/30 text-cyan-300 px-2 py-1 rounded">TypeScript</span>
